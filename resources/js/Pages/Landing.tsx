...
import PricingCardsSection from '@/Components/Section/PricingCardsSection';
import { Dialog } from 'primereact/dialog';
import { GlobalContext } from '@/Providers/GlobalContext';
import FormConsul from '@/Components/FormConsul';

type Props = {}

const landing:React.FC =  ({}: Props) => {
  // Global Context For Global State Management
  ...
  return (
    <LandingLayout title='Landing'>
      <div className='grid grid-cols-1 md:grid-cols-2 justify-center md:pt-20 pb-8 md:pb-40 bg-gradient-to-b from-red-500 to-red-600'>
        <div className="w-full flex justify-center">
            <div className="md:ml-24 md:me-10 mt-32">
                <h1 className="text-4xl text-center text-gray-100 font-bold">Siap-Siap Jago Bahasa Inggris dengan Program English Master!</h1>
                ...
                <div className="flex justify-center pt-6">
                    <button  onClick={() => actions.setVisibleModalConsul(true)} className="bg-yellow-400 hover:bg-yellow-500 text-black text-lg font-bold py-3.5 px-10 rounded-lg shadow-lg transition duration-300 hover:cursor-pointer">
                        Join Sekarang
                    </button>
                </div>
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-1 justify-center w-full md:pt-10'>
          ...
          <div className='md:pe-10'>
              ...
              <div className="flex justify-start">
                  ...
                  <iframe className='h-96 w-full px-4 pt-3 md:px-0 md:pt-0' src="https://www.youtube.com/embed/YKJGg3v2DnY?si=fAOlnbN9TPQ6_1Ev" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
              </div>
              {/* <div className="flex justify-end gap-2">
      ...
      <section className='pt-28 pb-10'>
        <div className='text-center pb-10 px-4'>
          <h2 className='md:text-4xl text-3xl font-semibold'> <span className='text-red-600 md:text-5xl text-4xl italic'>English Master</span> di LC beda Loh</h2>
        ...
        <div className='flex justify-center'>
          <div className='grid grid-cols-1 justify-items-center md:grid-cols-2 lg:grid-cols-3 md:gap-x-20 md:gap-y-8 px-4 gap-y-5'>
            ...
            <div className="max-w-sm p-6 pb-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-yellow-500 hover:shadow-lg hover:-translate-x-2 hover:-translate-y-2 transition-all ease-in duration-200">
                <h5 className="mb-2 tracking-tight text-gray-900 flex gap-2">
                  ...
                  <div>
                    <p className='text-lg font-bold'>Qualified & Experienced Teacher</p>
                    <p>Dibimbing teacher berpengalaman!</p>
                  </div>
                  </h5>
                <hr className='text-gray-300' />
                <p className="mt-2 font-normal text-gray-700">Teacher LC tuh kompeten dan siap bantu kamu berkembang dari nol sampai mahir dan ada Tutor Pendamping Asrama!</p>
            </div>
            ...
            <div className="max-w-sm p-6 pb-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-yellow-500 hover:shadow-lg hover:-translate-x-2 hover:-translate-y-2 transition-all ease-in duration-200">
                <h5 className="mb-2 tracking-tight text-gray-900 flex gap-2">
                  ...
                  <div>
                    <p className='text-lg font-bold'>Trip Ke Bali</p>
                    <p>Belajar + seru-seruan bareng!</p>
                  </div>
                  </h5>
                <hr className='text-gray-300' />
                <p className="mt-2 font-normal text-gray-700">Event seru ujian Akhir ke Bali yang bikin kamu makin pede tampil dan ningkatin skill public speaking!</p>
            </div>
            ...
            <div className="max-w-sm p-6 pb-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-yellow-500 hover:shadow-lg hover:-translate-x-2 hover:-translate-y-2 transition-all ease-in duration-200">
                <h5 className="mb-2 tracking-tight text-gray-900 flex gap-2">
                  ...
                  <div>
                    ...
                    <p>4x main class dan 2x camp class!</p>
                  </div>
                  </h5>
                <hr className='text-gray-300' />
                <p className="mt-2 font-normal text-gray-700">Speaking, grammar, sampai pronunciation dengan 4x main class dan 2x camp class semua dibungkus dalam metode belajar terintegrasi bareng lingkungan english area.</p>
            </div>
            ...
            <div className="max-w-sm p-6 pb-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-yellow-500 hover:shadow-lg hover:-translate-x-2 hover:-translate-y-2 transition-all ease-in duration-200">
                ...
                <hr className='text-gray-300' />
                <p className="mt-2 font-normal text-gray-700">Belajar di LC sesuai CEFR (Common European Framework of Reference for Languages) dan jangan lupa ada Modul Pembelajarannya.</p>
            </div>
      ...
      <section className='py-12'>
        <div>
          <h2 className='pb-8 text-2xl font-semibold tracking-tight leading-none md:text-4xl text-center'>Suasana Kampung Inggris LC</h2>
        </div>
        <div className='flex justify-center'>
      ...
      <section className='py-8 bg-gradient-to-b from-red-600 to-red-500'>
        <div>
          <h2 className='pb-8 text-2xl font-semibold tracking-tight leading-none md:text-4xl text-center text-gray-50'>Testimoni Para Alumni Kami</h2>
        </div>
        <div className='flex justify-center'>
      ...
      <section className='py-8'>
        <div>
          <h2 className='pb-8 px-4 text-xl font-semibold tracking-tight leading-none md:text-3xl text-center text-gray-900'>Teacher Kece yang Bakal Nemenin Kamu Belajar di LC pare!</h2>
        </div>
        <div className='flex justify-center'>
      ...
      <section className="bg-gradient-to-b from-red-600 to-red-500 pb-10">
          <div className="pt-8 px-4 mx-auto max-w-screen-xl text-center lg:pt-16 z-10 relative">
              <h1 className="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-50 md:text-3xl lg:text-4xl">Penawaran Spesial !</h1>
              <h1 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-50 md:text-4xl lg:text-5xl">Senilai <span className='text-yellow-300'>Rp. 342.000</span> </h1>
              <p className="mb-8 text-lg font-normal text-gray-100 lg:text-xl sm:px-16 lg:px-48">Khusus untuk Kamu yang mendaftar di periode ini!</p>
          </div>
          <div className='flex justify-center pb-6 px-2'>
            <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8">
              <div className="flex items-baseline text-gray-900">
                  <img src="/images/bonus_eksklusif.webp" alt="Bonus Eksklusif" />
              </div>
              <ul role="list" className="space-y-5 my-7">
                  <li className="flex items-center">
                      ...
                      <span className="text-lg font-normal leading-tight text-gray-500 ms-3">ECourse Cinch English</span>
                  </li>
                  <li className="flex">
                      <svg className="shrink-0 w-4 h-4 text-green-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                      </svg>
                      <span className="text-lg font-normal leading-tight text-gray-500 ms-3">Ebook Jago Ngomong Inggris</span>
                  </li>
                  <li className="flex">
                      <svg className="shrink-0 w-4 h-4 text-green-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                      </svg>
                      <span className="text-lg font-normal leading-tight text-gray-500 ms-3">EBook Introduce Yourself</span>
                  </li>
              </ul>
            </div>
          </div>
      ...
      <section className='py-16'>
        <div>
          <h2 className='pb-8 px-4 text-xl font-semibold tracking-tight leading-none md:text-3xl text-center text-gray-900 italic'>
            Set <span className='text-red-600'> Your English </span> Journey
          </h2>
          <h2 className='pb-8 px-4 text-xl font-semibold tracking-tight leading-none md:text-3xl text-center text-gray-900'>Pilih English Master Sesuai Kamu!</h2>
        </div>
       <PricingCardsSection></PricingCardsSection>
      </section>

      <section className='py-16 bg-gradient-to-b from-red-600 to-red-700'>
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-gray-200 md:text-4xl lg:text-5xl">Masih galau pilih program? <span className='text-yellow-400'>Konsultasi aja dulu!</span> </h1>
            <p className="mb-8 text-lg font-normal text-gray-200 lg:text-xl sm:px-16 lg:px-48">Konsultasi aja yuk, kami siap bantu pilih program yang paling pas buat kamu! <span className='text-yellow-400 underline'>Konsultasi gratis</span> kok, jadi nggak perlu ragu!</p>
            <div className="flex justify-center">
              <button  onClick={() => actions.setVisibleModalConsul(true)} className="bg-yellow-400 hover:bg-yellow-500 text-black text-lg font-bold py-3.5 px-10 rounded-lg shadow-lg transition duration-300 hover:cursor-pointer">
                  Konsultasi Yuk
              </button>
      ...
      <Dialog draggable={false} header="Konsultasi" visible={state.visibleModalConsul} className='w-11/12 md:w-1/2' onHide={() => {if (!state.visibleModalConsul) return; actions.setVisibleModalConsul(false); }}>
        <FormConsul></FormConsul>
      </Dialog>
